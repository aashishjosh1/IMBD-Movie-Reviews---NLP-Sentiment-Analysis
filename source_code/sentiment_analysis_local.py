...
with open(r'..\Sentiment Analysis - Natural Language Processing\model_artifacts\lr2.pkl', 'rb') as model_pkl:
    model = pickle.load(model_pkl)

#Load the saved Tf-Idf object using pickle
with open(r'..\Sentiment Analysis - Natural Language Processing\model_artifacts\tfidf.pkl', 'rb') as tfidf_pkl:
